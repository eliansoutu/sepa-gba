...
El <b style = "color: #d6ed64;">café</b> es el producto más caro de los analizados (si bien su peso en la alimentación es bajo) por amplia diferencia, explicado por la diversidad de marcas (nacionales e importadas) y formas de presentación. En promedio, para el GBA, un kilo de café ronda los <b style = "color: #d6ed64;">`r lbl_money(productos$precio[productos$categoria=="Café"])` pesos</b>.

:::

Por su parte, el producto más barato de la CBA es la <b style = "color: #d6ed64;">harina: `r lbl_money(productos$precio[productos$categoria=="Harina de trigo"])` pesos</b> en promedio por kilo. Le siguen, muy de cerca, la **papa** (`r lbl_money(productos$precio[productos$categoria=="Papa"])`) y la **batata** (`r lbl_money(productos$precio[productos$categoria=="Batata"])`). [@cr-productos-min]
